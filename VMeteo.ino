...
// Библиотеки для уличного датчика температуры
#include <OneWire.h>                       
#include <DallasTemperature.h>  
// Библиотека для домашнего датчика температуры
#include <DHT.h>
// Библиотека для часов
#include <ThreeWire.h>
#include <RtcDS1302.h>
// Библиотека для светодиода
#include <FastLED.h>
...
ThreeWire wiresRtc(RTC_IO, RTC_SCLK, RTC_CE); // IO, SCLK, CE
